...
CREATE UNIQUE INDEX "OrganizationMembership_one_owner_per_organization" ON "OrganizationMembership"("organizationId") WHERE "isOwner" = true AND "deletedAt" IS NULL;
